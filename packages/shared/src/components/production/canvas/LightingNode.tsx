...
import type { LightingNodeData } from '../../../types/canvas';

type LightingNode = Node<LightingNodeData, 'lighting'>;

function LightingNodeComponent({ data, selected }: NodeProps<LightingNode>) {
  ...
  const accentColor = selected ? 'rgba(250,204,21,0.9)' : 'rgba(250,204,21,0.5)';
