...
用法:
    python run_r21_parallel_test.py
"""
...
async def main():
    print(f"{'=' * 70}")
    print(f"  R21 并行优化验证 — GPT-5.4 (gpt-5.4)")
    ...
    # 打印最终汇总
    print(f"\n{'=' * 70}")
    print(f"  R21 测试总结 — GPT-5.4 并行优化验证")
    print(f"{'=' * 70}")
    ...
    print(f"  R21 合格标准: 角色>=6, 场景>=15, 位置>0, 变体>=8, 原文覆盖>=80%")
    ...
    # 保存汇总
    _save_json(Path(__file__).parent / "r21_summary.json", result)
